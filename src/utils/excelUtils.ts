    ...
    reader.onload = (e) => {
      try {
        ...
        rawRows.forEach((row, index) => {
          ...
          let ptn1 = '';
          let prodiPilihan1 = 'Teknik Informatika / Ilmu Komputer';
          let ptn2 = '';
          let prodiPilihan2 = 'Pendidikan Dokter / Kedokteran Umum';
          let noHp = '';
          let catatan = '';
          ...
          Object.keys(row).forEach((key) => {
            ...
            const mappedField = EXCEL_HEADER_MAPPING[cleanKey];
            ...
            if (mappedField === 'namaSiswa') namaSiswa = val;
              ...
              if (val.toUpperCase().includes('AKADEMI') || val.toUpperCase().includes('TNI')) {
                pilihanStudiLanjut = 'AKADEMI';
              } else if (val.toLowerCase().includes('kerja') || val.toLowerCase().includes('bekerja')) {
